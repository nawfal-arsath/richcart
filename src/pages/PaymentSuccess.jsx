...
export default function PaymentSuccess() {
  ...
  const sendCustomerWhatsApp = () => {
    ...
    const customerPhone = `91${order.customerPhone}`
      ...
      <div style={{ maxWidth: '480px', margin: '40px auto', padding: '0 20px 60px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: '15px', margin: 0, lineHeight: 1.6 }}>
            Your payment is verified. Now send the order confirmation to the customer on WhatsApp.
          </p>
        </div>

        {/* Order Summary */}
        <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #e5e7eb', padding: '20px', marginBottom: '16px' }}>
          <h2 style={{ fontSize: '13px', fontWeight: 700, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '1px', margin: '0 0 14px', paddingBottom: '10px', borderBottom: '1px solid #f3f4f6' }}>
            Order Summary
          </h2>
          ...
          <div style={{ marginBottom: '14px', paddingBottom: '14px', borderBottom: '1px solid #f3f4f6' }}>
            <p style={{ fontSize: '12px', fontWeight: 700, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.8px', margin: '0 0 10px' }}>Customer</p>
            ...
            <Row label="Status" value="✅ Verified" valueColor="#16a34a" />
          </div>

          {/* Address */}
          <div>
            <p style={{ fontSize: '12px', fontWeight: 700, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.8px', margin: '0 0 8px' }}>Delivery Address</p>
            <p style={{ fontSize: '14px', color: '#111827', lineHeight: 1.6, margin: 0 }}>{order.address}</p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '13px', color: '#1d4ed8', lineHeight: 1.5, margin: 0 }}>
            <strong>Estimated Delivery: 5–7 working days.</strong> Send the WhatsApp confirmation to the customer so they know their order is on the way.
          </p>
        </div>
        ...
        {!customerMsgSent ? (
          ...
          <div style={{ background: '#dcfce7', borderRadius: '12px', padding: '14px 16px', marginBottom: '12px', textAlign: 'center' }}>
            <p style={{ color: '#15803d', fontWeight: 600, fontSize: '14px', margin: 0 }}>
              ✓ Confirmation sent to customer on WhatsApp!
            </p>
          </div>
        )}
